package NORDICWH.bytebank;

import NORDICWH.bytebank.domain.cliente.DadosCadastroCliente;
import NORDICWH.bytebank.domain.conta.ContaService;
import NORDICWH.bytebank.domain.conta.DadosAberturaConta;
...
public class BytebankApplication {
    ...
    private static void encerrarConta() {
        ...
        service.encerrarAtiva(numeroDaConta);
